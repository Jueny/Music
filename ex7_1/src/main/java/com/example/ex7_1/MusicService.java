...
//                for(int i=0;i<4;i++){
//                    players[i]=MediaPlayer.create(MusicService.this, R.raw.dream);
//
//                }
                player=MediaPlayer.create(MusicService.this, R.raw.daoxian);
...
//                    sendBroadcast(musicIntent);
        ...
        public void sendMusicBroadcast(){
            Intent musicIntent=new Intent("com.example.music.MUSICBROCTASK");
            musicIntent.putExtra("current",current);
            musicIntent.putExtra("max",max);
            sendBroadcast(musicIntent);
        }
